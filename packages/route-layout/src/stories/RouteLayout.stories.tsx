...
import { RouteLayoutView, RouteLayoutViewProps } from './RouteLayoutView';
import logo from './assets/logo.svg';
import { routeData } from './data';

const meta: Meta<typeof RouteLayoutView> = {
  title: 'RouteLayout',
...
const args: RouteLayoutViewProps = {
  theme: 'light',
  routeData,
  title: 'Platform',
  logo,
...
export const TopMenuLight: Story = (args: RouteLayoutViewProps) => <RouteLayoutView {...args} />;
